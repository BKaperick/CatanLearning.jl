...
function Catan.do_post_action_step(board::Board, player::HybridPlayer)
...
function Catan.choose_next_action(board::Board, players::AbstractVector{PlayerPublicView}, player::HybridPlayer, actions::Set{PreAction})::ChosenAction
    best_action_index = 0
    best_action_proba = -1
